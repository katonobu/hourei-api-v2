...
class LawType(
  ...
  * `Misc`                 - その他
    ...
    @schemas.classproperty
    def CABINET_ORDER(cls):
        return cls("CabinetOrder")
    
    @schemas.classproperty
    def IMPERIAL_ORDER(cls):
        return cls("ImperialOrder")
    
    @schemas.classproperty
    def MINISTERIAL_ORDINANCE(cls):
        return cls("MinisterialOrdinance")
