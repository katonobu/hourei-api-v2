...
class LawRevisionsResponse(
    ...
    law_info: 'LawInfo'
    revisions: MetaOapg.properties.revisions
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["law_info"]) -> 'LawInfo': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["revisions"]) -> MetaOapg.properties.revisions: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["law_info", "revisions", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["law_info"]) -> 'LawInfo': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["revisions"]) -> MetaOapg.properties.revisions: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["law_info", "revisions", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        law_info: 'LawInfo',
        revisions: typing.Union[MetaOapg.properties.revisions, list, tuple, ],
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
