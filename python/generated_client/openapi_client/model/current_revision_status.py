...
class CurrentRevisionStatus(
  ...
  * `Repeal`           - 廃止法令（廃止・失効・実効性喪失）
    ...
    class MetaOapg:
        enum_value_to_name = {
            "CurrentEnforced": "CURRENT_ENFORCED",
            "UnEnforced": "UN_ENFORCED",
            "PreviousEnforced": "PREVIOUS_ENFORCED",
            "Repeal": "REPEAL",
        }
    
    @schemas.classproperty
    def CURRENT_ENFORCED(cls):
        return cls("CurrentEnforced")
    
    @schemas.classproperty
    def UN_ENFORCED(cls):
        return cls("UnEnforced")
    
    @schemas.classproperty
    def PREVIOUS_ENFORCED(cls):
        return cls("PreviousEnforced")
