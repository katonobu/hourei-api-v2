...
class LawDataResponse(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def attached_files_info() -> typing.Type['AttachedFilesInfo']:
                return AttachedFilesInfo
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["attached_files_info"]) -> 'AttachedFilesInfo': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["law_full_text"]) -> MetaOapg.properties.law_full_text: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["attached_files_info", "law_info", "revision_info", "law_full_text", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["attached_files_info"]) -> typing.Union['AttachedFilesInfo', schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["law_full_text"]) -> typing.Union[MetaOapg.properties.law_full_text, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["attached_files_info", "law_info", "revision_info", "law_full_text", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        attached_files_info: typing.Union['AttachedFilesInfo', schemas.Unset] = schemas.unset,
        ...
        law_full_text: typing.Union[MetaOapg.properties.law_full_text, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'LawDataResponse':
        return super().__new__(
