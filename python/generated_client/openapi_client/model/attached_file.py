...
class AttachedFile(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["law_revision_id", "src", "updated", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["law_revision_id", "src", "updated", ], str]):
