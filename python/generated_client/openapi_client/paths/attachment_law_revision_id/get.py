...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'src': typing.Union[SrcSchema, str, ],
    },
    total=False
)
...
request_query_src = api_client.QueryParameter(
    name="src",
...
# Path params
LawRevisionIdSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'law_revision_id': typing.Union[LawRevisionIdSchema, str, ],
    }
)
...
request_path_law_revision_id = api_client.PathParameter(
    name="law_revision_id",
    style=api_client.ParameterStyle.SIMPLE,
    schema=LawRevisionIdSchema,
    required=True,
)
